...
@implementation TLWImagePickerView
...
- (void)tl_setupHeader {
  ...
  subtitle.text = @"请选择要发布的图片";
  subtitle.font = [UIFont systemFontOfSize:18 weight:UIFontWeightMedium];
...
- (void)tl_setupConfirmButton {
  ...
  NSMutableAttributedString *title = [[NSMutableAttributedString alloc] initWithString:@"完成" attributes:@{
