...
- (void)viewDidLoad {
    ...
    [collectionView registerClass:[TLWCommunityCell class]
        forCellWithReuseIdentifier:kCommunityCellID];

    // TODO: 搜索按钮、上传按钮交互后续接入
    [self.myView.uploadButton addTarget:self
                                 action:@selector(tl_upload)
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    TLWCommunityCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kCommunityCellID
