...
- (void)tl_setupSearchBar {
  ...
  UIImageView *backView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"cp_back.png"]];
  backView.contentMode = UIViewContentModeScaleAspectFit;
  [container addSubview:backView];

  UIButton *uploadButton = [UIButton buttonWithType:UIButtonTypeCustom];
  [uploadButton setImage:[UIImage imageNamed:@"cp_cloud.png"] forState:UIControlStateNormal];
  //    uploadButton.adjustsImageWhenHighlighted = YES;
  uploadButton.configurationUpdateHandler = ^(UIButton *btn) {
