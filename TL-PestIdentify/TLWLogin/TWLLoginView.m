...
// 条款行
@property (nonatomic, strong) UIImageView      *checkImageView;   // Vector-4.png
...
- (void)setupBackground {
    // 底部颜色.png 作为全屏背景
    UIImageView *bgImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"底部颜色"]];
    ...
    // Rectangle 233.png 与底边对齐，实现渐变叠加效果
    UIImageView *rectView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Rectangle 233"]];
...
- (void)setupLogoArea {
    ...
    [_logoBgView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mas_safeAreaLayoutGuideTop).offset(116);
    ...
    _logoImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Group 1927"]];
...
- (void)setupForm {
    ...
    UIImage *loginBg = [[UIImage imageNamed:@"Rectangle218"]
...
- (void)setupTermsRow {
    ...
    _checkImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Vector-4"]];
    _checkImageView.contentMode = UIViewContentModeScaleAspectFit;
    [wrapper addSubview:_checkImageView];
    ...
    agreeLabel.text      = @"我已阅读并同意以上条款";
    agreeLabel.font      = [UIFont systemFontOfSize:15 weight:UIFontWeightMedium];
    ...
    [agreeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_checkImageView.mas_right).offset(8);
...
- (void)setupBottomSection {
    ...
    [dividerView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.mas_safeAreaLayoutGuideBottom).offset(-106);
    ...
    UIImageView *wechatIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"weixin"]];
    ...
    [wechatLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(wechatIcon.mas_bottom).offset(5);
        make.centerX.equalTo(_wechatLoginButton);
    ...
    UIImageView *phoneIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Vectorphone"]];
